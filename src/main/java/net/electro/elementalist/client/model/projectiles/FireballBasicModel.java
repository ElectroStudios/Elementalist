package net.electro.elementalist.client.model.projectiles;// Made with Blockbench 4.5.2
...
public class FireballBasicModel extends EntityModel<FireballBasicProjectile> {
	...
	public FireballBasicModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 0.0F));
