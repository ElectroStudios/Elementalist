...
public class IceSpearModel extends EntityModel<IceSpear> {
	...
	@Override
	public void setupAnim(IceSpear entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
